...
public class ServiceController {
	...
	@RequestMapping("/findServiceLikeByTypeAndStatus/{curPage}")
	public String findServiceLikeByTypeAndStatus(@PathVariable int curPage,CstService serve,HttpSession session) {
		PageInfo<CstService> serveInfo = serveService.findServiceLikeByTypeAndStatus(serve, curPage, 5);
		session.setAttribute("services", serveInfo);
		return "service/feedback";
	}
}
