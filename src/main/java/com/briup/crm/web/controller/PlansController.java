...
public class PlansController {
	...
	@RequestMapping("/findPlanByPlanId/{planId}")
	@ResponseBody
	public SalPlan findPlanByPlanId(@PathVariable long planId) {
		SalPlan plan = planService.findPlanByPlanId(planId);
		return plan;
	}
	
	@RequestMapping("/deletePlanByPlanId/{planId}")
	public String deletePlanByPlanId(@PathVariable long planId,HttpSession session) {
		long chanceId = (long) session.getAttribute("chanceId");
