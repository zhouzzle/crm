    ...
    <div class="modal-content">
       <form>
					<div class="modal-body">
						...
						<div class="form-group">
							<label>服务反馈结果:</label>
							<input type="text" name="svrResult" class="form-control">
						</div>
						
						<div class="form-group">
							<label>客户满意度:</label>
							<select name="svrSatisfy" id="" class="form-control">
						...
						<div class="form-group">
							<label>状态:</label>
							<input type="text" name="svrStatus" class="form-control" value="已处理" disabled>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('.search').click(function(){
			...
			var url = "service/findServiceLikeByTypeAndStatus/1";
